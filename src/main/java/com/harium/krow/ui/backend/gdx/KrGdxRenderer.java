package com.harium.krow.ui.backend.gdx;
...
import com.harium.krow.ui.KrColor;
import com.harium.krow.ui.KrToolkit;
import com.harium.krow.ui.render.KrBrush;
import com.harium.krow.ui.render.KrColorBrush;
import com.harium.krow.ui.render.KrDrawableBrush;
import com.harium.krow.ui.render.KrPen;
...
public class KrGdxRenderer extends KrRenderer {
    ...
    private Drawable getRoundedRectDrawable(int radius) {
        switch (radius) {
            case 1:
            case 2:
                return KrToolkit.getDefaultToolkit().getSkin().getDrawable("rounded_rect_2");
            case 3:
                return KrToolkit.getDefaultToolkit().getSkin().getDrawable("rounded_rect_3");
            case 4:
                return KrToolkit.getDefaultToolkit().getSkin().getDrawable("rounded_rect_4");
            case 5:
                return KrToolkit.getDefaultToolkit().getSkin().getDrawable("rounded_rect_5");
            case 6:
                return KrToolkit.getDefaultToolkit().getSkin().getDrawable("rounded_rect_6");
            default:
                return KrToolkit.getDefaultToolkit().getSkin().getDrawable("rounded_rect_2");
        }
    }
