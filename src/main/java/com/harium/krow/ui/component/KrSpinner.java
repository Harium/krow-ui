...
import static com.harium.krow.ui.event.KrMouseEvent.Button.LEFT;
import static com.harium.krow.ui.event.KrMouseEvent.Button.RIGHT;
...
public class KrSpinner extends KrTextField {
    ...
    public KrSpinner() {
        setDefaultStyle(KrToolkit.getDefaultToolkit().getSkin().getStyle(KrSpinner.class));
