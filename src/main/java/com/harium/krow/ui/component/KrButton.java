...
import com.harium.krow.ui.util.KrStrings;
...
public class KrButton extends KrWidget {
    ...
    public KrButton(String text) {
        setText(text);
        setDefaultStyle(KrToolkit.getDefaultToolkit().getSkin().getStyle(KrButton.class));
    ...
    public Vector2 calculatePreferredSize() {
        return KrRectangles.rectangles(getContentSize()).expand(getPadding()).size();
    }
    ...
    private Vector2 getContentSize(Vector2 contentSize) {
        KrRectangles rects = KrRectangles.rectangles(0, 0);
