...
import com.harium.krow.ui.event.listener.KrFocusListener;
import com.harium.krow.ui.event.listener.KrKeyboardListener;
...
public class KrWidget implements KrUpdateListener, Disposable {
    ...
    public void setBackground(Color background) {
        setBackground(KrToolkit.getDefaultToolkit().getDrawable(background));
    }
    ...
    public void validate() {
        ...
        Rectangle layoutRectangle = KrRectangles.rectangles(geometry).shrink(padding).value();
