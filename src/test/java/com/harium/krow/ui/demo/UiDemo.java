package com.harium.krow.ui.demo;
...
import com.harium.krow.ui.*;
import com.harium.krow.ui.backend.gdx.KrGdxBackend;
import com.harium.krow.ui.component.*;
import com.harium.krow.ui.layout.KrAbsoluteLayout;
import com.harium.krow.ui.layout.KrBorderLayout;
import com.harium.krow.ui.layout.KrCardLayout;
import com.harium.krow.ui.layout.KrFlowLayout;
import com.harium.krow.ui.layout.KrGridLayout;
...
import com.harium.krow.ui.icon.KrFontAwesomeIcon;
import com.harium.krow.ui.icon.KrIcon;
import com.harium.krow.ui.model.KrItemModel;
import com.harium.krow.ui.model.KrListItemModel;
...
public class UiDemo extends Game {
    ...
    public void create() {
        ...
        Gdx.input.setInputProcessor((InputAdapter) KrToolkit.getDefaultToolkit().getInputSource());
        canvas = KrToolkit.getDefaultToolkit().getCanvas();

        darkGray = KrToolkit.getDefaultToolkit().getDrawable(KrColor.rgb(0x434343));
        darkerGray = KrToolkit.getDefaultToolkit().getDrawable(KrColor.rgb(0x393939));
        lightGray = KrColor.rgb(0xaaaaaa);
...
//        canvas.getRootPanel().add(createSandbox());
    ...
    private KrCollapsiblePanel createCollapsiblePanel() {
        ...
        contentPanel.setBackground(KrToolkit.getDefaultToolkit().getSkin().getColor(KrSkin.ColorKey.BACKGROUND_LIGHT));
    ...
    private KrMenu createMenu() {
        ...
        menu.addMenuItem(new KrMenu.KrMenuItemSeparator());
        menu.addMenuItem(new KrMenu.KrMenuItem("Save"));
        menu.addMenuItem(new KrMenu.KrMenuItem("Save All"));
        menu.addMenuItem(new KrMenu.KrMenuItem("Export"));
    ...
    private KrWidget createTooltipWidget() {
        ...
        tooltipWidget.setLayout(new KrFlowLayout(KrOrientation.VERTICAL));
    ...
    private KrPanel createListView() {
        ...
        wrapper.add(listView, KrBorderLayout.Constraint.CENTER);
    ...
    private KrPanel createTableView() {
        ...
        wrapper.add(label, KrBorderLayout.Constraint.NORTH);
        wrapper.add(table, KrBorderLayout.Constraint.CENTER);
        wrapper.setPreferredHeight(120);
    ...
    private KrWidget createButtons() {
        ...
        button.addListener(() -> menu.showAt(KrToolkit.getDefaultToolkit().getInputSource().getMousePosition()));
    ...
    private KrWidget createScrollPanel() {
        ...
        wrapper.add(label, KrBorderLayout.Constraint.NORTH);
        wrapper.add(scrollPanel, KrBorderLayout.Constraint.CENTER);
        wrapper.setPreferredHeight(120);
    ...
    private KrPanel createVerticalScrollBarPanel() {
        KrScrollBar scrollBar = new KrScrollBar(KrOrientation.VERTICAL);
    ...
    private KrPanel createHorizontalScrollBarPanel() {
        KrScrollBar scrollBar = new KrScrollBar(KrOrientation.HORIZONTAL);
    ...
    private KrWidget createHorizontalFlowLayoutPanel() {
        ...
        KrPanel panel = new KrPanel();
        panel.setLayout(new KrFlowLayout(KrOrientation.HORIZONTAL, 5, 5));
    ...
    private KrWidget createVerticalFlowLayoutPanel() {
        ...
        panel.setLayout(new KrFlowLayout(KrOrientation.VERTICAL, 5, 5));
    ...
    private KrWidget createGridLayout() {
        ...
        fields.add(usernameLabel, new KrGridLayout.Constraint(KrAlignment.MIDDLE_RIGHT, false, false));
        fields.add(usernameEdit, new KrGridLayout.Constraint(KrAlignment.MIDDLE_LEFT, true, false));
        fields.add(weight, new KrGridLayout.Constraint(KrAlignment.MIDDLE_RIGHT, false, false));
        fields.add(weightEdit, new KrGridLayout.Constraint(KrAlignment.MIDDLE_LEFT, true, false));
        fields.add(genderLabel, new KrGridLayout.Constraint(KrAlignment.MIDDLE_RIGHT, false, false));
        fields.add(genderEditor, new KrGridLayout.Constraint(KrAlignment.MIDDLE_LEFT, true, false));

        KrPanel form = new KrPanel(new KrFlowLayout(KrOrientation.VERTICAL));
        form.add(formLabel);
        form.add(fields);
    ...
    public KrPanel createDummyContent(String text) {
        KrPanel panel = new KrPanel() {
            @Override
            protected void drawSelf(KrRenderer renderer) {
                renderer.setBrush(KrToolkit.getDefaultToolkit().getSkin().getColor(KrSkin.ColorKey.BORDER));
        ...
        panel.add(new KrLabel(text), KrBorderLayout.Constraint.CENTER);
        return panel;
    }
    ...
    public void render() {
        ...
        KrToolkit.getDefaultToolkit().update(deltaTime);
        canvas.draw();
    }
